...
class LocalStatusCoordinatorInstrumentedTest {
    ...
    private class FakeGateway(
        private val poll: suspend (LocalPollRequest) -> LocalPollResult,
    ) : TuyaPythonGateway {
    ...
    private class FakeStore(
        ...
        override suspend fun mergeLocalPoll(result: LocalPollResult): DeviceCatalog {
            ...
            return catalog.copy(
                ...
                localStatus = result.devices.map { device ->
                    LocalStatusRecord(
                        id = device.id,
                        state = device.state,
    ...
    private companion object {
        ...
        fun sampleCatalog(): DeviceCatalog = DeviceCatalog(
            schemaVersion = 2,
        ...
        fun lanDevice(id: String, lastSeenAt: Long, ip: String) = LanDeviceRecord(
            id = id,
            ip = ip,
            protocolVersion = "3.5",
            productKey = "",
        ...
        fun samplePollResult() = LocalPollResult(
            contractVersion = 1,
            deviceCount = 1,
