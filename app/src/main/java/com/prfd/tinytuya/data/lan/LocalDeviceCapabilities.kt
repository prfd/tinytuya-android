...
private fun LocalStatusRecord?.toObservation(lastDiscoveryAtEpochMillis: Long?): DeviceObservation {
  val fresh =
    this != null &&
...
private fun LocalDataPointKind.toObservedKind(): ObservedDataPointKind =
  when (this) {
...
private fun CloudImportedDevice.toDeviceIdentity(): DeviceIdentity =
