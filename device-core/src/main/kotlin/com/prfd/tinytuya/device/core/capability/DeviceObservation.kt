...
class ObservedDataPointInput(
    ...
    override fun toString(): String =
        "ObservedDataPointInput(id=$id, kind=$kind, value=[REDACTED])"
}

class ObservedDataPoint internal constructor(
    val id: String,
    val kind: ObservedDataPointKind,
    val value: String,
) {
    override fun toString(): String =
        "ObservedDataPoint(id=$id, kind=$kind, value=[REDACTED])"
}
...
class DeviceObservation private constructor(
    ...
    companion object {
        ...
        fun empty(isFresh: Boolean = false): DeviceObservation = DeviceObservation(
        ...
        fun normalize(
            ...
            return DeviceObservation(
                dataPoints = pointsById.values.sortedWith(
                    compareBy<ObservedDataPoint> { point ->
                        point.id.toLongOrNull() ?: Long.MAX_VALUE
