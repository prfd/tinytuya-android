...
object SensorSummaryLayoutRenderer : DeviceLayoutRenderer {
  ...
  override fun Content(
    ...
    Column(
      modifier = modifier.fillMaxWidth().padding(top = 10.dp).testTag("local_sensor_summary")
    ) {
      Surface(
        ...
        border =
          if (tone == CapabilityTone.NEUTRAL) {
...
private fun DeviceUiModel.sensorReadings(): List<CapabilityUiModel> =
